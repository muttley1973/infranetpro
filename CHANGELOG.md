...
Groundwork only: nothing here changes what the app shows or does yet — these are the layers
under the multi-site feature, not the feature (plan: `_local/notes/PIANO_multi-sede-wan-vpn.md`).
