...
const PROMPTS = {
  it: [
    ...
    '  listPartial, outletsPartial) dice che quella RELAZIONE è TAGLIATA — ne vedi',
    '  "shown" su "of". Con una topologia parziale NON rispondere su cosa è',
    '  collegato a cosa, su che strada fa il traffico o su cosa cade se qualcosa si',
    '  spegne; con porte o prese parziali NON rispondere su chi alimenta chi né su',
    '  quali porte sono libere. Dillo: «vedo N collegamenti su M, non posso',
  ...
  en: [
    ...
    '  outletsPartial) means that RELATION is TRUNCATED - you see "shown" of "of".',
    '  With a partial topology do NOT answer what is connected to what, which path',
    '  traffic takes, or what falls when something goes down; with partial ports or',
    '  outlets do NOT answer who powers what or which ports are free. Say it: "I can',
    '  see N links out of M, I cannot answer that". A missing piece of a graph does',
    '  not shorten the answer, it makes it WRONG, and from the inside you cannot tell.',
