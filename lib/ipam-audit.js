    ...
    for (let i = 0; i < parsed.length; i++) {
      for (let j = i + 1; j < parsed.length; j++) {
        ...
        out.push({
          ...
          // Si sovrappongono e hanno lo stesso prefisso => sono la STESSA rete.
          // Vale per v4 e v6 senza guardare campi che su v6 non esistono.
          identical: a.cidr.prefix === b.cidr.prefix,
        });
      }
    }
