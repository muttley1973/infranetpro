...
(function (root, factory) {
  ...
  // Le due porte «off» MISURATE dallo switch (lib/port-state.js), su una scala
  // monocroma che finisce nel grigio neutro di STATUS_COLOR.inactive. Vincono su
  // qualunque stato dichiarato: e' la sola parte del disegno dove parla l'apparato.
  const SHUT_COLOR   = '#0a0d11';   // spenta a mano (`shutdown`) — una decisione
  const NOLINK_COLOR = '#3c4149';   // nessun link da >=N verifiche — un sintomo
