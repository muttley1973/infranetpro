  ...
  function buildInterSiteWanReport(org, opts) {
    ...
    const links = linksIn.map(l => {
      ...
      return {
        ...
        // L'underlay di un SD-WAN: le linee VERE sotto l'overlay. Un id che non
        // risolve resta in elenco marcato `found:false` — sparire lascerebbe
        // credere che l'overlay poggi su una linea in meno di quante ne dichiara.
