...
(function (root, factory) {
...
})(typeof self !== 'undefined' ? self : this, function (vn, pidApi) {
  'use strict';
  ...
  function buildSnmpSnapshot(model) {
    ...
    if (reach) { for (const ip of Object.keys(reach)) { if (reach[ip] && reach[ip].alive) { const n = _net24(ip); if (n) observedSubnets.add(n); aliveIps.add(String(ip)); } } }
    const ports = {};
