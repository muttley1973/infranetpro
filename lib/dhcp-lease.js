...
(function (root, factory) {
  ...
  // Dedup per MAC (identità = MAC): tiene il lease con `expiry` più recente
  // (un MAC ha un solo IP corrente; gli storici hanno scadenza più vecchia).
  ...
  return { parseDhcpLeases, detectLeaseFormat, reconcileDhcpLeases, normalizeLeaseRecords };
});
