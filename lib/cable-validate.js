...
(function (root, factory) {
  ...
  function validateCable(link, opts) {
    ...
    // 11) VLAN CONSENTITE asimmetriche sui due capi del trunk. La nativa la copre
    ...
    //     alza e passa quel che entrambe le liste hanno in comune, mentre le VLAN
    //     presenti da una parte sola muoiono sul cavo. E' la causa piu' comune del
    //     «funziona per alcune VLAN e non per altre», e la piu' difficile da vedere
    //     proprio perche' il link e' UP e i contatori girano.
    //
    //     ⚠️ `warn` e non `error`: potare una VLAN da un trunk e' una pratica
    //     legittima, e da fuori non si distingue una potatura voluta da una
