...
(function (root, factory) {
  ...
  const BACKUP_FRESH_DAYS = 90;   // un puntatore più vecchio è "stantìo": non è un piano DR
  ...
  function _recovery(m) {
    ...
    const noBackup = [], noIdentity = [], noLocation = [], stalePresence = [];
    let okBackup = 0, okIdentity = 0, okLocation = 0, staleBackup = 0, idMismatch = 0;
    let recoverable = 0, withObs = 0;
