...
(function (root, factory) {
  ...
  function certaintyForCable(proofState, lsCertaintyKey) {
    // Il ramo senza Verifica deve avere la STESSA forma dell'altro: con il solo
    // `grade` il tipo dell'unione perde `labelKey`, e la riga sotto lo legge.
    const p = proofState ? certaintyOf('proof', proofState) : { grade: null, labelKey: null };
