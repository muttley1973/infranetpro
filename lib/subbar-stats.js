...
(function (root, factory) {
  ...
  function computeSubbarStats(nodes, types) {
    ...
    return { devices, passive, addressable, withIp, docPct, snmpTotal, snmpOk, snmpDown, snmpHealth };
  }
  ...
  return { computeSubbarStats, computeTopoHiddenCables, _hasSnmp, _isAddressable };
});
