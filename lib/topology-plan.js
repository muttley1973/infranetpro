...
(function (root, factory) {
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = factory(require('./netnames'), require('./port-id.js'));
  } else {
    Object.assign(root, factory(root, root)); // browser: netnames e port-id già su window
  }
})(typeof self !== 'undefined' ? self : this, function (nn, pidApi) {
  'use strict';
