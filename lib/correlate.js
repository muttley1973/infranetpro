...
(function (root, factory) {
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = factory(require('./netnames'), require('./ipv6'), require('./port-id.js'));
  } else {
    Object.assign(root, factory(root, root)); // browser: netnames + ipv6 già su window
  }
})(typeof self !== 'undefined' ? self : this, function (nn, v6, pidApi) {
  'use strict';
  ...
  function buildArpCandidates(arpTable, opts) {
    ...
    const localSubnets = o.localSubnets || null; // Set<"a.b.c"> = subnet del COLLECTOR (on-segment)
    ...
    for (const macRaw of Object.keys(arpTable)) {
      ...
      if (localSubnets) {
        ...
        if (m && localSubnets.has(m[1])) continue;
      }
      const mac = _normMacKey(macRaw);
