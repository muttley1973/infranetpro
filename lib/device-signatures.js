...
(function (root, factory) {
  ...
  const OID_TYPE_VOTES = [
    ...
    // vpncon (95) — riallineamento tassonomia 2026-07-22: Altiga = Cisco VPN 3000
    // Concentrator, il tipo 'vpncon' esiste in TYPES (era classificato firewall).
    { prefix: '1.3.6.1.4.1.3076.',    type: 'vpncon',   points: 95 }, // Altiga (Cisco VPN 3000 Concentrator)
    // ups (85)
