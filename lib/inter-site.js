...
/** ⑳ `underlayUplinkIds` NON è più qui: è comune. Resta `overlay`, che dell'SD-WAN
 *  è davvero — il nome della rete logica che la sua console mostra, e che su un
 *  IPsec o un VPLS non vuol dire niente.
 *  @typedef {InterSiteLinkCommon & {kind:'sdwan', overlay:string|null}} SdwanLink */
