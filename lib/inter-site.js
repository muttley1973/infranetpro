 ...
 *  @typedef {'ipsec'|'mpls'|'vpls'|'sdwan'|'directLink'|'other'} InterSiteKind */
...
/** @typedef {IpsecLink|CarrierLink|SdwanLink|DirectLink|OtherLink} InterSiteLink */
...
(function (root, factory) {
  ...
  const INTER_SITE_KINDS = ['ipsec', 'mpls', 'vpls', 'sdwan', 'directLink', 'other'];
