    ...
    if (!anyUplink) {
      ...
      if (!conNumeri.length) notChecked.push({ check: 'uplinksImplausible', reason: 'no-numbers' });
        ...
        for (const u of conNumeri) {
          ...
          if (u.cirMbps !== null && u.cirMbps > CIR_MAX_MBPS) {
