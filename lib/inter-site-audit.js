 ...
 *  Le prime SEI sono INCOERENZE (qualcosa non torna), le altre cinque LACUNE
...
(function (root, factory) {
  ...
  function buildInterSiteAudit(rawOrg) {
    ...
    /** @type {{id:string, kind:string, aSiteId:string, bSiteId:string, reach:unknown, topology:string|null}[]} */
