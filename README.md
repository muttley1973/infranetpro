...
- **LAG member consistency** — the LAG section of the device panel warns when a group's member ports have **different speeds or access/native VLANs** (they wouldn't bundle on real hardware); pure `lib/lag-audit.js`. LACP mode itself is out of scope
