...
- [x] **draw.io (diagrams.net) rack export** (`lib/drawio-export.js`): native mxGraph rack diagram, one page per rack, devices/ports/SNMP-stripe as editable cells in draw.io's own numbered rack container (snap-to-U); geometry calibrated against diagrams.net by round-trip; zero embedded-image artefacts
